...
<head>
    ...
    <script>
        $(document).ready(function() {
            <?php 
                if (isset($_GET['id'])) {
                    echo "var url='https://topup304cembackend.herokuapp.com/getAllFav/'+'".$_GET['id']."';";
                }
            ?>
            ...
            $.ajax({
                ...
                success: function(e) {
                    ...
                    for (var j = 0; j < e.length; j++) {
                        str = "";
                        var link = 'https://topup304cembackend.herokuapp.com/getAllFavMv/' + e[j].mvid;
                        $.ajax({
                            type: 'GET',
                            url: link,
                            async: false,
        ...
        function checkfavMv(id, i) {
            var link = "https://topup304cembackend.herokuapp.com/getFav/" + id + "/" + "<?php echo $_SESSION['id']; ?>";
            $.ajax({
                type: 'GET',
        ...
        function unFavMv(id) {
            var link = "https://topup304cembackend.herokuapp.com/unFav/" + id + "/" + "<?php echo $_SESSION['id']; ?>";
            $.ajax({
                type: 'DELETE',
                contentType: 'application/json',
                url: link,
